...
export default function MedicalPage() {
  ...
  return (
    <PageShell title={t('dashboard.medical.title')}>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              placeholder={t('dashboard.medical.searchPlaceholder')}
        ...
        <div className="rounded-2xl border border-scout-gray-lighter bg-white p-12 shadow-sm text-center">
          <div className="w-16 h-16 rounded-full bg-scout-neutral mx-auto mb-4 flex items-center justify-center">
            <Stethoscope className="w-8 h-8 text-scout-gray-light" />
          </div>
          <h3 className="text-lg font-medium text-scout-green mb-2">{t('dashboard.medical.emptyTitle')}</h3>
          <p className="text-sm text-scout-gray max-w-md mx-auto">{t('dashboard.medical.emptyDescription')}</p>
        </div>
      </div>
    </PageShell>
  );
